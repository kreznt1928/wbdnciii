...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        ...
        $order_query = "INSERT INTO orders (total_price, customer_name) VALUES (?, ?)";
        $stmt = $conn->prepare($order_query);
        $stmt->bind_param("ds", $total_price, $customer_name);
        $stmt->execute();
        ...
        $order_items_query = "INSERT INTO order_details (order_id, product_id, quantity, price) VALUES (?, ?, ?, ?)";
        ...
        echo json_encode(array('success' => true, 'redirect' => '/rollie/index.php?status=success'));
        exit();
    } catch (Exception $e) {
